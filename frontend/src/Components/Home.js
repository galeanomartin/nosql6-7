...
import banner from "../Images/marvelandc.jpg";
import logo from "../Images/marvel-dc-logo.png";
import app from "../Images/app.ico";
    ...
    <div style={body}>
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary navbar-fixed-top">
       ...
       <a className="navbar-brand" href="/">
         ...
         {/*<<a className="navbar-brand" href="/">
          <img src={app} alt="Marvel-DC" style={image_app} />
        </a>*/}
      ...
      <div className="jumbotron">
        ...
        {/*<h4 className="text-dark" align="center">MARVEL / DC</h4>*/}

        {loading ? (
          <div style={styleLoader}>
            {" "}
            <Loader type="Watch" color="#63696E" height={150} width={150} />{" "}
            <h3>Cargando Superheroes... </h3>
          </div>
        ) : (
